namespace AdventOfCode.Year2025
{
    public class Day4
    {
        ...
        {
            string basePath = Environment.GetEnvironmentVariable("ADVENT_OF_CODE"); string configFile = Path.Combine(basePath, "AdventOfCode\\Year2025\\inputs\\day4.txt"); string input = System.IO.File.ReadAllText(configFile);
