namespace AdventOfCode.Year2025
{
    public class Day6
    {
        ...
        {
            string basePath = Environment.GetEnvironmentVariable("ADVENT_OF_CODE"); string configFile = Path.Combine(basePath, "AdventOfCode\\Year2025\\inputs\\day6.txt"); string input = System.IO.File.ReadAllText(configFile);
